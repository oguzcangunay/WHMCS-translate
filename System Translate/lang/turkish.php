...
$_LANG['networkIssuesAware'] = "Potansiyel olarak hizmeti etkileyen bir sorunun farkındayız.";
$_LANG['networkIssuesScheduled'] = "Hizmetlerimizi etkileyebilecek yaklaşan bakım olayları var.";
...
$_LANG['pwresetrequested'] = "Şifre Sıfırlama İstendi";
$_LANG['pwresetcheckemail'] = "Girdiğiniz e-posta adresi mevcut bir hesapla eşleşiyorsa, daha sonra ne yapacağınızla ilgili talimatlar için lütfen e-postanızı kontrol edin.";
...
$_LANG['configoptionqtyminmax'] = "%s minimum %s ve maksimum %s gereksinimine sahiptir";
...
$_LANG['twoipinstruct'] = "Using an authenticator app like %s or %s, scan the QR code below. Having trouble scanning the code? Enter the code manually:"; //OGDS
...
$_LANG['upgradeSameProductMustExtendCycle'] = "Faturalandırma döngünüzü yükseltmek için lütfen mevcut faturalandırma döngünüzden daha büyük bir döngü seçin.";
...
$_LANG['orderForm']['promoCycles'] = "Expires after :cycles billing period/s";     //OGDS
...
$_LANG['markdown']['exampleLink'] = "http://www.oguzcangunay.com";
...
$_LANG['store']['sitelock']['features']['spamBlacklistMonitoring'] = "Spam Kara Liste İzleme";
...
$_LANG['pricingCycleShort']['monthly'] = "1 Aylık";
$_LANG['pricingCycleShort']['quarterly'] = "3 Aylık";
$_LANG['pricingCycleShort']['semiannually'] = "6 Aylık";
$_LANG['pricingCycleShort']['annually'] = "1 Yıllık";
$_LANG['pricingCycleShort']['biennially'] = "2 Yıllık";
$_LANG['pricingCycleShort']['triennially'] = "3 Yıllık";
...
$_LANG['pricingCycleLong']['biennially'] = "2 Yıl";
$_LANG['pricingCycleLong']['triennially'] = "3 Yıl";
...
$_LANG['marketConnect']['weebly']['ftpHost'] = "FTP Sunucusu";
...
$_LANG['dateTime']['mon'] = "Pazartesi";
$_LANG['dateTime']['tue'] = "Salı";
$_LANG['dateTime']['wed'] = "Çarşamba";
$_LANG['dateTime']['thu'] = "Perşembe";
$_LANG['dateTime']['fri'] = "Cuma";
$_LANG['dateTime']['sat'] = "Cumartesi";
$_LANG['dateTime']['sun'] = "Pazar";
$_LANG['dateTime']['th'] = "th";
$_LANG['dateTime']['nd'] = "nd";
$_LANG['dateTime']['rd'] = "rd";    //OGDS
...
$_LANG['dateTime']['jan'] = "01";
$_LANG['dateTime']['feb'] = "02";
$_LANG['dateTime']['mar'] = "03";
$_LANG['dateTime']['apr'] = "04";
$_LANG['dateTime']['may'] = "05";
$_LANG['dateTime']['jun'] = "06";
$_LANG['dateTime']['jul'] = "07";
$_LANG['dateTime']['aug'] = "08";
$_LANG['dateTime']['sep'] = "09";
$_LANG['dateTime']['oct'] = "10";
$_LANG['dateTime']['nov'] = "11";
$_LANG['dateTime']['dec'] = "12";
$_LANG['dateTime']['AM'] = "AM";
$_LANG['dateTime']['PM'] = "PM";
$_LANG['dateTime']['am'] = "am";
$_LANG['dateTime']['pm'] = "pm";
$_LANG['dateTime']['day'] = "Gün";
$_LANG['dateTime']['days'] = "Günler";
$_LANG['dateTime']['hour'] = "Saat";
$_LANG['dateTime']['hours'] = "Saatler";
$_LANG['dateTime']['minute'] = "Dakika";
$_LANG['dateTime']['minutes'] = "Dakikalar";

$_LANG['emailMarketing']['joinOurMailingList'] = "Mail listemize katılın";
...
$_LANG['gracePeriod'] = "Yetkisiz Kullanım Süresi";
$_LANG['redemptionPeriod'] = "Kullanım Dönemi";
$_LANG['domainsExpiringSoon'] = "Yakında Sona Eriyor";
$_LANG['expiresToday'] = "Süresi Bugün Doluyor";
$_LANG['clientareagrace'] = "Yetkisiz Kullanım Süresi (Süresi Doldu)";
$_LANG['clientarearedemption'] = "Kullanım Süresi (Süresi Doldu)";
$_LANG['domainRenewal']['availablePeriods'] = "Kullanılabilir Yenileme Dönemleri";
$_LANG['domainRenewal']['unavailable'] = "Etki Alanı Yenileme Kullanılamıyor";
$_LANG['domainRenewal']['renewingDomains'] = "Etki Alanlarınızı Yenileyin";
$_LANG['domainRenewal']['graceFee'] = "Ödemesiz Dönem Ücreti";
$_LANG['domainRenewal']['redemptionFee'] = "Geri Ödeme Dönemi Ücreti";
$_LANG['domainRenewal']['graceRenewalPeriodDescription'] = "Etki alanları, süresi dolduktan sonra Yetkisiz Kullanım Süresi'ne girer. Bu statüye girdikten sonra, etki alanı yalnızca en fazla minimum kayıt dönemi süresi için yenilenebilir.";
$_LANG['domainRenewal']['hasExpired'] = "Alan adının süresi doldu.";
$_LANG['domainRenewal']['expiringIn'] = ":days Gün içinde sona eriyor";
$_LANG['domainRenewal']['expiredDaysAgo'] = ":days Gün önce süresi doldu";
$_LANG['domainRenewal']['noDomains'] = "Şu anda yenilemeye uygun herhangi bir alan adınız yok";
$_LANG['domainRenewal']['showingDomains'] = ":totalCount taneden :showing tane gösteriliyor";
$_LANG['domainRenewal']['showAll'] = "Hepsini göster";
$_LANG['domainRenewal']['maximumAdvanceRenewal'] = "Maksimum avans yenilemesi :days gündür";

$_LANG['navMarketConnectService']['sitelock'] = "Web Sitesi Güvenliği";
$_LANG['store']['sitelock']['title'] = "SiteLock Web Sitesi Güvenliği";
$_LANG['store']['sitelock']['tagline'] = "Web sitenizi kötü amaçlı yazılımlara karşı otomatik olarak tarayın ve çevrimiçi itibarı koruyun";
$_LANG['store']['sitelock']['manageService'] = "SiteLock Hizmetinizi Yönetme";
$_LANG['store']['sitelock']['cartShortDescription'] = "SiteLock, hem web sitenizi hem de işletmenizin itibarını korumak için tasarlanmış bir dizi özellik sağlar.";
$_LANG['store']['sitelock']['plansAndPricing'] = "Planlar ve Fiyatlandırma";
$_LANG['store']['sitelock']['featuresLink'] = "Özellikler";
$_LANG['store']['sitelock']['websiteHacked'] = "Web Sitesi Hacklendi mi?";
...
$_LANG['store']['sitelock']['contentBodyParagraph1'] = "SiteLock&trade;, web sitesi güvenliğinde küresel lider, size huzur vermek için web sitenizi korur.";
$_LANG['store']['sitelock']['contentBodyParagraph2'] = "SiteLock'un Günlük Kötü Amaçlı Yazılım Taraması, güvenlik açıklarını ve bilinen kötü amaçlı kodu tanımlar ve web sitenizi ve ziyaretçilerinizi tehditlere karşı korumak için web sitenizden otomatik olarak kaldırır.";
$_LANG['store']['sitelock']['contentBodyParagraph3'] = "Ayrıca, müşteri güvenini artıran ve satış ve dönüşüm oranlarını artırdığı kanıtlanmış Olan SiteLock Güven Damgası'na sahip olursunuz.";
...
$_LANG['store']['sitelock']['featuresMalwareContent'] = "Web sitenizde algılanan kötü amaçlı yazılımları proaktif olarak izler ve sizi uyarır.";
$_LANG['store']['sitelock']['featuresMalwareRemovalTitle'] = "Otomatik kötü amaçlı yazılım temizleme";
$_LANG['store']['sitelock']['featuresMalwareRemovalContent'] = "Tarama bir şey bulursa, SiteLock bilinen kötü amaçlı yazılımları otomatik olarak güvenli bir şekilde kaldırır.";
$_LANG['store']['sitelock']['featuresVulnerabilityTitle'] = "Güvenlik Açığı Taraması";
$_LANG['store']['sitelock']['featuresVulnerabilityContent'] = "Uygulamalarınızın güncel olduğundan ve bilinen güvenlik açıklarına karşı güvende olduğundan emin olmak için uygulamalarınızı otomatik olarak kontrol eder.";
$_LANG['store']['sitelock']['featuresOWASPTitle'] = "OWASP Koruması";
$_LANG['store']['sitelock']['featuresOWASPContent'] = "Açık Web Uygulaması Güvenlik Projesi OWASP tarafından tanınan en iyi 10 web uygulaması güvenlik açığına karşı koruma alın.";
$_LANG['store']['sitelock']['featuresTrustSealTitle'] = "SiteLock&trade; Güven Damgası";
...
$_LANG['store']['sitelock']['featuresReputationContent'] = "Günlük taramalar, arama motorlarının onu bulma ve sitenizi kara listeye alma şansına sahip olmadan önce kötü amaçlı yazılımları erken tespit etmenize yardımcı olur.";
$_LANG['store']['sitelock']['featuresSetupTitle'] = "Hızlı otomatik kurulum";
$_LANG['store']['sitelock']['featuresSetupContent'] = "Anında ve tam otomatik kurulum, yüklenecek hiçbir şey olmadan hemen koruma sağlar.";
$_LANG['store']['sitelock']['featuresCDNTitle'] = "İçerik Teslim Ağı (CDN)";
$_LANG['store']['sitelock']['featuresCDNContent'] = "Web sitenizi küresel olarak dağıtarak ve nerede olurlarsa olsunlar daha hızlı sayfa yükleme hızları için ziyaretçilerinize en yakın konumdan sunarak hızlandırın.";
$_LANG['store']['sitelock']['emergencyPlanTitle'] = "Web Sitesi Hacklendi mi?";
$_LANG['store']['sitelock']['emergencyPlanHeadline'] = "SiteLock Acil Durum Yanıtı ile şimdi düzeltin";
$_LANG['store']['sitelock']['emergencyPlanBody'] = "Web siteniz saldırıya uğradıysa ve güvenliği ihlal edildiyse, sitenizi hızlı bir şekilde kurtarmak için acil yardım alın. SiteLock Acil Durum Yanıtı şu şekilde yardımcı olur:";
$_LANG['store']['sitelock']['emergencyPlanResponseTitle'] = "Anında yanıt";
$_LANG['store']['sitelock']['emergencyPlanResponseContent'] = "Analiz ile en hızlı yanıt süremizi alın ve sitenizi 30 dakika içinde kurtarmak için çalışın.";
$_LANG['store']['sitelock']['emergencyPlanMalwareTitle'] = "Kötü amaçlı yazılımların temizlenmesini tamamlayın";
...
$_LANG['store']['sitelock']['emergencyPlanPriorityContent'] = "Acil durum paketi ile kuyruğun en üstüne kadar hızlı bir şekilde izlenirsiniz.";
$_LANG['store']['sitelock']['emergencyPlanAftercareTitle'] = "7 gün bakım sonrası";
$_LANG['store']['sitelock']['emergencyPlanAftercareContent'] = "Sitenizi temizleme ve kurtarma süreci boyunca gerçek zamanlı güncellemelerimizle ilerlemeyi takip edin.";
$_LANG['store']['sitelock']['emergencyPlanUpdatesTitle'] = "Gerçek zamanlı güncellemeler";
$_LANG['store']['sitelock']['emergencyPlanAftercareContent'] = "Sitenizi temizleme ve kurtarma süreci boyunca gerçek zamanlı güncellemelerimizle ilerlemeyi takip edin.";
$_LANG['store']['sitelock']['emergencyPlanPaymentTitle'] = "Tek Sefer Ödeme";
$_LANG['store']['sitelock']['emergencyPlanPaymentContent'] = "Acil servis tek seferlik ücret karşılığında kullanılabilir, yinelenen ücret veya abonelik yoktur.";
$_LANG['store']['sitelock']['emergencyPlanOnlyCost'] = "Tek seferlik 7 gün koruma için :price";
$_LANG['store']['sitelock']['buyNow'] = "Satın Al";
$_LANG['store']['sitelock']['faqTitle'] = "Sıkça Sorulan Sorular";
$_LANG['store']['sitelock']['faqOneTitle'] = "SiteLock nedir?";
$_LANG['store']['sitelock']['faqOneBody'] = "SiteLock, her boyuttaki web sitesine basit, hızlı ve uygun fiyatlı web sitesi güvenliği sağlar. 2008 yılında kurulan şirket, dünya çapında 12 milyondan fazla web sitesini korumamaktadır. SiteLock bulut tabanlı ürün paketi, otomatik web sitesi güvenlik açığı algılama ve kötü amaçlı yazılımların temizlenmesi, DDoS koruması, web sitesi hızlandırma, web sitesi risk değerlendirmeleri ve PCI uyumluluğu sunar.";
$_LANG['store']['sitelock']['faqOneBodyLearnMore'] = "SiteLock hakkında daha fazla bilgi edinmek için :learnMoreLink";
$_LANG['store']['sitelock']['faqOneBodyLearnLinkText'] = "buraya tıklayarak 'SiteLock Nasıl Çalışır' videosunu izleyebilirsiniz";
$_LANG['store']['sitelock']['faqTwoTitle'] = "SiteLock ne işe yarar?";
$_LANG['store']['sitelock']['faqTwoBody'] = "SiteLock kapsamlı web sitesi güvenliği sağlar. Güvenlik açıklarını veya kötü amaçlı yazılımları belirlemek için web sitesi günlük taramaları gerçekleştirir. Güvenlik açıkları veya kötü amaçlı yazılımlar bulunduğunda, hemen uyarılırsınız. SiteLock tarayıcınıza bağlı olarak, web sitenizdeki kötü amaçlı yazılımları otomatik olarak kaldırır.  İçerik yönetim sistemi (CMS) web siteleri için SiteLock, bulunan güvenlik açıklarına otomatik olarak yama yapabilir.";
$_LANG['store']['sitelock']['faqThreeTitle'] = "SiteLock ne tür sorunları tarar?";
$_LANG['store']['sitelock']['faqThreeBody'] = "SiteLock, aşağıdakileri kapsayan kapsamlı bir web sitesi taraması yapma teknolojisine sahiptir:";
$_LANG['store']['sitelock']['faqThreeBodyList1Title'] = "Dosya Tabanlı Kötü Amaçlı Yazılım Tarama ve Kaldırma";
$_LANG['store']['sitelock']['faqThreeBodyList1'] = "SiteLock, bir web sitesinin dosyalarını kötü amaçlı yazılımlara karşı günlük taramalar gerçekleştirir. Kötü amaçlı yazılım bulunursa, web sitesi sahibi hemen uyarılır. SiteLock ayrıca kötü amaçlı yazılımı otomatik olarak kaldırmak için kapsamlı taramalar sunar.";
$_LANG['store']['sitelock']['faqThreeBodyList2Title'] = "Güvenlik Açığı Taraması";
$_LANG['store']['sitelock']['faqThreeBodyList2'] = "SiteLock, bir uzlaşmaya yol açabilecek yaygın güvenlik açıkları için web sitesi uygulamalarını tarar.";
$_LANG['store']['sitelock']['faqThreeBodyList3Title'] = "Uygulama Güvenliği ve Güvenlik Açığı Düzeltme Eki Uygulama";
$_LANG['store']['sitelock']['faqThreeBodyList3'] = "SiteLock, içerik yönetim sistemlerindeki (CMS) güvenlik açıklarını otomatik olarak düzeltme eki uygulama teknolojisine sahiptir.";
$_LANG['store']['sitelock']['faqFourTitle'] = "Güvenlik açıkları ve kötü amaçlı yazılımlar nelerdir?";
$_LANG['store']['sitelock']['faqFourBodyParagraph1'] = ":vulnerabilityStrong bir web sitesinde veya web uygulama kodunda, saldırganın sitenin ve muhtemelen barındırma sunucusunun denetimini bir düzeyde ele almasına olanak tanıyan bir zayıflık veya yanlış yapılandırmadır. Güvenlik açıklarının çoğu, güvenlik açığı tarayıcıları ve botnet'ler gibi otomatik yollarla yararlanır.";
$_LANG['store']['sitelock']['websiteVulnerability'] = "Web sitesindeki güvenlik açığı";
$_LANG['store']['sitelock']['faqFourBodyParagraph2'] = ":malwareStrong. kötü amaçlı yazılımların kısaltması, hassas verileri toplamak, web sitelerine yetkisiz erişim elde etmek ve hatta bilgisayarları ele geçirmek için kullanılır.";
$_LANG['store']['sitelock']['malware'] = "Kötü Amaçlı Yazılım";
$_LANG['store']['sitelock']['faqFiveTitle'] = "SiteLock web sitesi performansını etkiler mi?";
$_LANG['store']['sitelock']['faqFiveBody'] = "NHayır. Bir web sitesi taraması sırasında, SiteLock ilgili dosyaları güvenli bir sunucuya indirir ve orada taramalar gerçekleştirir. Web sitesindeki web sitesi içeriği, kodu, bant genişliği veya sunucu kaynakları üzerinde hiçbir etkisi yoktur.";
$_LANG['store']['sitelock']['faqSixTitle'] = "SiteLock Güven Mührü nedir?";
$_LANG['store']['sitelock']['faqSixBody'] = "SiteLock Güven Damgası, web sitenizde görüntülenebileceğiniz yaygın olarak tanınan bir güvenlik rozetidir. Web sitenizin güvenli ve kötü amaçlı yazılım içermediğinin açık bir göstergesidir. Mührü web sitenize eklemek için SiteLock'un web sitenizin altbilgi alanına sağladığı kod snippet'ini eklemeniz yeterlidir.";

$_LANG['learnmore'] = "Daha fazla bilgi edinin";
...
$_LANG['dismiss'] = "Kapatmak";

$_LANG['store']['emailServices']['manageService'] = "SpamExperts Denetim Masası'na giriş yapın";
